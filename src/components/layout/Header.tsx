...
export default function Header() {
  ...
  return (
    <header className="fixed flex max-w-[940px] w-full min-h-[50px] h-[90px] items-center flex-col px-5 pt-5 pb-8 gap-4 min-w-[240px] bg-white z-[999] border border-x-0 border-t-0">
